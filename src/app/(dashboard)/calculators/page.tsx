  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
          ...
          <Card className="h-full cursor-pointer hover:shadow-lg transition-shadow">
            <div className="flex flex-col h-full">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="text-lg font-semibold text-[var(--ink)]">LBO Calculator</h3>
              ...
              <ul className="mt-4 space-y-2 text-xs text-[var(--ink-mute)]">
        ...
        <Link href="/calculators/valuation">
          <Card className="h-full cursor-pointer hover:shadow-lg transition-shadow">
            <div className="flex flex-col h-full">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="text-lg font-semibold text-[var(--ink)]">Valuation</h3>
                  <p className="text-sm text-[var(--ink-soft)] mt-1">
        ...
        <Link href="/calculators/dd-checklist">
          <Card className="h-full cursor-pointer hover:shadow-lg transition-shadow">
            <div className="flex flex-col h-full">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="text-lg font-semibold text-[var(--ink)]">DD Checklist</h3>
                  <p className="text-sm text-[var(--ink-soft)] mt-1">
      ...
      <Card title="How to Use These Tools" className="mt-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <h4 className="font-semibold text-[var(--ink)] mb-2">LBO Calculator</h4>
          ...
          <div>
            <h4 className="font-semibold text-[var(--ink)] mb-2">Valuation Tools</h4>
            <p className="text-sm text-[var(--ink-soft)]">
          ...
          <div>
            <h4 className="font-semibold text-[var(--ink)] mb-2">DD Checklist</h4>
            <p className="text-sm text-[var(--ink-soft)]">

      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              To request deletion of your account and associated data, contact us at <a href="mailto:invest@kunfa.ai" className="text-[var(--accent-ink)] hover:underline">invest@kunfa.ai</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              To exercise any of these rights, please contact us at <a href="mailto:invest@kunfa.ai" className="text-[var(--accent-ink)] hover:underline">invest@kunfa.ai</a>. We will respond to your request within 30 days.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              Email: <a href="mailto:invest@kunfa.ai" className="text-[var(--accent-ink)] hover:underline">invest@kunfa.ai</a>
            </p>
          </section>
        </div>
      </main>

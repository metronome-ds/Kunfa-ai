...
export async function GET(request: NextRequest) {
  ...
  const selectCols = isAdmin
    ? 'id, company_name, slug, logo_url, one_liner, industry, stage, founder_name, country, overall_score, is_raising, raise_amount, created_at, source, is_public, claim_status, claim_invited_email'
    : 'id, company_name, slug, logo_url, one_liner, industry, stage, founder_name, country, overall_score, is_raising, raise_amount, created_at, source, is_public';

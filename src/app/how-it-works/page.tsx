      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mb-16">
          ...
          <ul className="space-y-3 text-sm text-gray-700 leading-relaxed">
            ...
            <li className="flex gap-3">
              <span className="text-[var(--accent-ink)] font-bold">2.</span>
              <span>
            ...
            <li className="flex gap-3">
              <span className="text-[var(--accent-ink)] font-bold">3.</span>
              <span>
            ...
            <li className="flex gap-3">
              <span className="text-[var(--accent-ink)] font-bold">4.</span>
              <span>

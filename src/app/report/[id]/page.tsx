          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#10B981] text-white rounded-lg font-semibold text-sm hover:bg-[#059669] transition disabled:opacity-50"
              >
        ...
        {status === 'unpaid' && (
          <div className="max-w-lg mx-auto text-center py-16">
            ...
            <button
              ...
              className="bg-[#10B981] text-white px-8 py-4 rounded-xl font-semibold text-base hover:bg-[#059669] transition shadow-lg"
            >
              Unlock Report — $59
            </button>
        ...
        {status === 'error' && (
          <div className="max-w-lg mx-auto text-center py-16">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <Link href="/dashboard" className="text-[#10B981] font-semibold text-sm hover:underline">
                Go to Dashboard
              </Link>
            </div>
          </div>

          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0168FE] text-white rounded-lg font-semibold text-sm hover:bg-[#0050CC] transition disabled:opacity-50"
              >
        ...
        {status === 'unpaid' && (
          <div className="max-w-lg mx-auto text-center py-16">
            <div className="w-20 h-20 bg-blue-50 rounded-full flex items-center justify-center mx-auto mb-6">
              <svg className="w-10 h-10 text-[#0168FE]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="bg-[#0168FE] text-white px-8 py-4 rounded-xl font-semibold text-base hover:bg-[#0050CC] transition shadow-lg"
            >
              Unlock Report — $59
            </button>
            <div className="mt-8 grid grid-cols-2 gap-3 text-left max-w-sm mx-auto">
              {[
                ...
                <div key={item} className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#0168FE] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {status === 'error' && (
          <div className="max-w-lg mx-auto text-center py-16">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <Link href="/dashboard" className="text-[#0168FE] font-semibold text-sm hover:underline">
                Go to Dashboard
              </Link>
            </div>
          </div>

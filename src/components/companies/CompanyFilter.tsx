      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-1 focus:ring-[var(--ink)]"
          >
            ...
            {sortedIndustries.map((industry) => (
              <label key={industry} className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-[var(--accent-ink)] rounded border-gray-300 cursor-pointer"
                />

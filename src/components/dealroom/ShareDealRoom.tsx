            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 mb-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 bg-[var(--ink)] text-white rounded-lg text-sm font-medium hover:bg-[var(--ink-2)] transition flex items-center gap-1"
                >
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6 border border-gray-200">
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={createLink}
                disabled={creating}
                className="w-full py-2.5 bg-[var(--ink)] text-white rounded-lg text-sm font-medium hover:bg-[var(--ink-2)] transition disabled:opacity-50"
              >
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        >
                          {link.is_active ? (
                            <ToggleRight className="w-4 h-4 text-[var(--accent-ink)]" />
                          ) : (

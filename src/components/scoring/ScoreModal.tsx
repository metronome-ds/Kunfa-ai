          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {slugStatus === 'available' && (
                <p className="text-xs text-[var(--accent-ink)] mt-1">This URL is available!</p>
              )}
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[var(--bg-sunk)] rounded-lg p-3">
              ...
              <div className="w-full h-2 bg-[var(--bg-sunk)] rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${scoreStrength}%`,
                    backgroundColor: scoreStrength >= 80 ? '#10b981' : scoreStrength >= 60 ? '#1c1c28' : scoreStrength >= 40 ? '#f59e0b' : '#9ca3af',
                  }}
                />
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-full bg-[var(--accent-soft)] text-[var(--accent-ink)]">RECOMMENDED</span>
              </div>
              <UploadZone
                label="Tap to upload"
